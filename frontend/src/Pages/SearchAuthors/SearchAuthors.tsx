...
const SearchBooks: React.FC = () => {
  const { searchResults, status, error } = useSelector((state: RootState) => state.searchAuthors);

  return (
    <div className="lg:m-24 m-4">
      <h2 className="text-3xl font-bold text-center mb-8">Yazar Arama Sonuçlarınız</h2>
