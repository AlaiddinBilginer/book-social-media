        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuthorComments_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicationDate = table.Column<short>(type: "smallint", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AuthorId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "040c4b71-36f6-4bad-a1f0-364fdeea5fff", null, "Admin", "ADMIN" },
                    { "1c7a5e7b-2c97-4e2c-a49a-c840b007fa45", null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorComments_AppUserId",
